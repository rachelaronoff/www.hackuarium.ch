...
It is also important to set a unique qualifier for the bioreactor. You should fill the [list](03-qualifiers.md) with a free
code.
...
It is important to note that an error (stored in [PARAM_ERROR](../01-platformio/02-parameters.md#PARAM_ERROR) will be generated if the pH is either under the minimal value or over the maximal value and this should stop all the functions for pH control.
...
It is important to note that an error (stored in [PARAM_ERROR](../01-platformio/02-parameters.md#PARAM_ERROR) will be generated if the EC is either under the minimal value or over the maximal value.
